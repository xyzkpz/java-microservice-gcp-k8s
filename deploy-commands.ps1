# GCP Java Microservice Deployment - PowerShell Commands
...
$env:CLUSTER_NAME = "java-microservice-cluster"
...
gcloud container images describe gcr.io/$env:PROJECT_ID/java-microservice:latest
...
# Watch for External IP (press Ctrl+C to stop)
...
docker build -t gcr.io/$env:PROJECT_ID/java-microservice:v2 .
docker push gcr.io/$env:PROJECT_ID/java-microservice:v2

# Update deployment to use new image
kubectl set image deployment/java-microservice `
  java-microservice=gcr.io/$env:PROJECT_ID/java-microservice:v2
...
gcloud container clusters delete $env:CLUSTER_NAME --zone=$env:ZONE

# Delete Docker images from GCR (optional)
gcloud container images delete gcr.io/$env:PROJECT_ID/java-microservice:latest --quiet
...
# Resize cluster
gcloud container clusters resize $env:CLUSTER_NAME --num-nodes=5 --zone=$env:ZONE

# Get cluster credentials
gcloud container clusters get-credentials $env:CLUSTER_NAME --zone=$env:ZONE

# View cluster details
gcloud container clusters describe $env:CLUSTER_NAME --zone=$env:ZONE
